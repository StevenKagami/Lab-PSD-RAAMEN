<%@ Page Title="" Language="C#" MasterPageFile="~/View/NavigationBar.Master" AutoEventWireup="true" CodeBehind="UpdateRamen.aspx.cs" Inherits="RAAMEN.View.UpdateRamen" %>
    ...
    <h1>Update Ramen</h1>
        <div style="display:flex; flex-direction:column; gap:10px; margin-top:30px;">
            ...
            <div class="broth">
                ...
                <asp:Label ID="BrothEmpty" runat="server" Visible="false" style="color:red;" Text="Broth must be filled!" ></asp:Label>
            </div>
            ...
            <div class="updateButton">
                <asp:Button ID="UpdateBtn" runat="server" Text="Update" OnClick="UpdateBtn_Click" BackColor="LightGreen" Width="100"/>
            </div>
